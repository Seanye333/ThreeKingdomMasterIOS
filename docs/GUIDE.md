...
| 行軍節奏 | 急行軍 −1旬·每季累毙−3%·抵達疲勞士氣−12 / 常行 / 緩進 +1旬·孤軍折損減半(§4.1) |
...
- **行軍節奏(`marchPace.ts`,出陣時擇)**:**急行軍**(−1 旬,但每季**累毙** −3% 掉隊、抵達**疲勞**〔自動結算之戰開局士氣 −12,以逸待勞〕)/ **常行** / **緩進**(+1 旬,但**孤軍深入折損減半**、就糧充裕)。兵貴神速 vs 持重穩進,成了真實權衡。
