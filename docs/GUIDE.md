...
> **初始靜態關係**(`relationships.ts` 的 `OFFICER_RELATIONSHIPS`,2026-07 由 173→194):補錄演義名場面的宿敵/血仇/主僕/師徒 —— 關羽×黃忠(長沙)/龐德(抬櫬)/顏良(白馬)、趙雲×文醜(磐河)/張郃(長坂)、張飛×馬超(葭萌)、馬超×許褚(潼關)、太史慈×孫策(神亭)、黃忠×夏侯淵(定軍山)、姜維×鄧艾/郭淮,甘寧×凌統(殺父)/馬超×曹操(滅族)血仇,劉備×趙雲/諸葛(魚水)主僕,呂布×陳宮、司馬徽薦龐統、董卓×貂蟬。讓這些名場面關係**一開局就激活**羈絆同陣戰力、宿敵對決 +10%、招募修正、AI 攻擊猶豫(見 §5.1 / relationshipEffects.ts)。
