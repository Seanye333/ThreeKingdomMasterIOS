...
- **大地圖資訊層「米價」**(疊層第 7 檔,熱鍵 7),**並疊上上一季實際跑過的商旅路線** —— 虛線沿陸路畫,粗細隨運量,境內琥珀、跨境淡金。刻意只在此層顯示:糧往紅處流,線與色是同一件事。原句::全境城池按金/百石著色 —— 綠為穀賤傷農、赤為米珠薪桂,標籤直接寫價。**貴的地方就是商旅已經在路上的地方,也是圍城會更快咬下去的地方**。
