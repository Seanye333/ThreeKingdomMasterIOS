...
- **遣名士品評**(`appraiseOfficer`):以麾下**最敏銳之名士**(智 ≥78,`canAppraise`)為其下一**定評**:
  - **定評(`appraisalVerdict`)** 依五圍/性格擇辭:有志而能的奸雄得「**治世之能臣,亂世之奸雄**」(許劭評曹操);智政俱高者「王佐之才」;武力 ≥90「萬人之敵」(傲者另綴「然性矜高」);智謀/能吏/國士/庸才各有其評。附**品第**(上/中/下品,`appraisalGrade`)。
  - **揚名(`appraisalRenownGain`)**:一評成名 —— 被評者得**名望**(名士越著名〔智越高〕、品第越高則越多,3~20),名士自身亦得**識人之名**(約四成)。定評永久記於武將詳情(如生涯銘文)。
  - 一人一評(已評不再評),不可重刷。AI 自知麾下虛實,本系統為**玩家專屬的識人工具**。
