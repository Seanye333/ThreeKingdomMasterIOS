...
4. **舉薦(賢以薦賢,`recommendation.ts`)**:每季,在職且有識見(智或魅 ≥72)的我方武將有機率**舉薦**一名在野隱才 —— 優先薦其**有淵源者**(師承/義結/同門,讀 `OFFICER_RELATIONSHIPS`)或**同鄉**,否則薦其耳聞之士。被薦者就地現身為在野(待延攬),省去盲目探訪。史上人才多由此而來(徐庶薦諸葛亮、荀彧薦郭嘉)。
5. **子嗣出仕**(見第二章)。
...
- **三顧之誠(persistence)**:屢請不輟,每次婉拒累積 **+0.05**(封頂 +0.20)誠意,鍥而不捨終得之(三顧茅廬)。
