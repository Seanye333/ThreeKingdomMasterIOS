...
- **民忠的全盤下漂,與「被自己人拖垮」的一家(2026-08-05)**:190 盤上曹操五城掉到一城,追六輪十四次失城 —— **無主(民變)七次、黃天教四次、鄰國只有三次**。他不是被打垮的,是外圍城池自己爛掉:白馬民忠 79→50、延津 79→40(110 回合)。
  - 先猜是「無人牧守」(九將全擠在許昌),把人鋪開再量 —— **曲線一模一樣**,白馬仍在第 70 回合跌到 23。再往外量才看見這是全盤的事:鄴 58→51、南皮 55→20、彭城 64→27、襄陽 51→41,多數城在 20–60 這一帶往下漂,而許昌與下邳反而爬到 100。民忠到 20 就民變,那是機制,不是某一家的毛病。
