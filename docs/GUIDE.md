...
- **絕命詩**(`deathPoems.ts`,39 首):名將身故時,季報附上其絕命詩(史實或演義)。除關羽/諸葛亮/曹操等既有 22 首外,2026-07 補入荀彧(空函見賜)、趙雲(一身是膽)、太史慈(當帶三尺之劍)、張遼、馬超(託孤馬岱)、孫堅、孫權、陸遜(忠讜見疑)、曹丕(典論論文)、董卓、袁術(至於此乎)、郭嘉(遺計定遼東)、許褚、夏侯惇(拔矢啖睛)、龐德(抬櫬決死)、王允、魯肅(榻上策)共 17 首。
