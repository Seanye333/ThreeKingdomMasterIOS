...
- **氛圍與旁白(flavor 層)**:戰場語音(voiceLines.ts —— 出陣/斬將/危殆台詞;2026-07 由 20→39 人:先補三國陸遜/姜維/龐德/張郃/鄧艾/魏延/夏侯淵/徐晃,再補**歷代名將**項羽(力拔山兮氣蓋世)/李存孝/霍去病(匈奴未滅何以家為)/白起/韓信(背水列陣)/岳飛(還我河山)/常遇春/薛仁貴(三箭定天山)/蘭陵王/尉遲恭/李廣(飛將軍)—— 跨界名冊的頂級猛將原有決鬥台詞卻無戰場語音)、季度隨機對話事件(dialogues.ts / dialogueRoll,多為趣味、少數有實際效果)、派系事件(factionEvents.ts)、AI 朝廷請願旁白(aiWishesFlavor.ts —— 每季 0~2 條,且晉升/賞賜會真的調動軍階與忠誠)。
