...
| 1 | [城市・內政・經濟](#第一章-城市內政經濟) | citySize, economy, commands, civicEvents, market(行情/榷場/馬市/鐵市), buildings(含戰損修繕), cityCivic(民情街景/城中人物/晝夜/街頭際遇/官邸家眷), autoBuild, policyEffects, **law(律令寬嚴/訟獄積案/決獄/冤獄/大赦)**, **household(隱戶/徭役/括戶)**, **culturalWorks(題詠/文集/立祠)**, forging, specialties, specialtyEvents, tradeRoutes, convoy | ✅ |
...
| 隱戶與稅基(§1.12) | 漂移=徭役壓力+律令(峻0.5/寬−0.3)+民心(≥70 −0.3/<40 +0.4)−政治/90,夾在 2%~45%;金糧收入 ×(1−隱戶%×0.8/100);括戶 200金 清 min(隱戶−2, 2+政治/14) 點永久回籍,民忠−2、城中世家將 −4 忠誠 |
...
- **隱戶(City.hiddenHouseholds,2%–45%)**:每季漂移 = 徭役壓力 + 律令(峻法 +0.5 / 寬刑 −0.3)+ 民心(≥70 −0.3 / <40 +0.4)− 駐城最高政治/90。**隱戶直接壓稅基**:該城金與糧收入 ×(1 − 隱戶%×0.8/100)—— 隱戶 45% 時只收得到 64%。
- **徭役三等(度支簿設定)**:
