...
| 全軍集結令 | 合格城(駐軍≥3000/有閒將/付軍費)向任意城收束:攻/勤王/集結點;先預覽(路數·兵·金·ETA·排除),可調比例/守軍底線/排前線(§4.2) |
...
- **集結點・分進合擊**:對**自家前進城**集結 → 各路先匯於此**蓄勢**,再由你一齊扑向目標,免添油送菜被各個擊破。
- **選擇性集結(`MusterOptions`)**:可調**出兵比例**(0.3~1,預設 0.7)、設**保留守軍底線**(`keepGarrison`,不把邊城抽空)、**排除前線城**(與他國接壤者守軍留邊)。
- 各路仍走正規行軍管線(行軍節奏/隨軍糧/孤軍深入/攔截皆適用)。仍為**玩家專屬**便利令;AI 走軍團(§4.3)。
