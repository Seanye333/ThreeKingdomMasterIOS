...
| 升級經驗門檻(6 級) | 100 / 250 / 500 / 900 / 1500 / 2500 | growth |
| 升級成長 | min(150, 當前 + max(8, ⌊(150−當前)×25%⌋)) | growth |
| 成年出仕 | 14 歲 | family |
...
| 項 | 公式 / 值 |
|---|---|
| 金收 /季 | ⌊商業 × 人口/4000⌋ × 政策倍率 × 等級倍率 × 威名倍率 + 政策定額 |
| 糧收 /秋 | ⌊農業 × 人口/1000⌋ × 等級糧倍 + 義倉 |
...
| 結局(6 種) | 天下統一 / 漢室再興 / 三國鼎立 / 隱士退隱 / 即位稱帝 / 敗亡 |
...
flowchart TD
  ...
  F --> H
  H --> I{"檢查結局條件"}
  I -->|達成| J["🏆 結局:統一 / 漢室再興 / 三國鼎立 / 隱士退隱 / 即位稱帝 / 敗亡"]
  I -->|未達| K["旬結束 → 下一旬"]
```
