...
| 器魂戰技 | 進化(·神)神兵賦持有者一招命名戰技,單挑勇 +8、**武魂槽 +30% 加速(必殺更快)**;隨兵器易手;軒轅一斬/斬白蛇… | evolvedArts, duel |
| 統御信物 | 虎符/帥印/兵符/節鉞/令旗(統率+6~8)己方 +4%/人戰力(封頂+8%)+ **駐城 +10%/人募兵上限** + **戰術:半徑4內友軍 +6% 統御光環** | items, combat, resolution, tactical |
