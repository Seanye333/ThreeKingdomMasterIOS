"""Render the V33-exact Zhao Yun full-body composite."""
...
BLEND = SRC / "zhao-yun-fullbody-v7-exact-face.blend"
PREVIEW = SRC / "zhao-yun-fullbody-v7-exact-face-preview.png"
FINAL = SRC / "zhao-yun-fullbody-v7-exact-face-final.png"
