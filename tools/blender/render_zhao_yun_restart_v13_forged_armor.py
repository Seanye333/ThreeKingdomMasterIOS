"""Render the forged-armor Zhao Yun restart."""
...
BLEND = SRC / "zhao-yun-restart-v13-forged-armor.blend"
PREVIEW = SRC / "zhao-yun-restart-v13-forged-armor-preview.png"
FACE = SRC / "zhao-yun-restart-v13-forged-armor-face.png"
...
def polished_render():
    for obj in bpy.data.objects:
        for particle_system in obj.particle_systems:
            settings = particle_system.settings
            settings.rendered_child_count = min(settings.rendered_child_count, 20)
