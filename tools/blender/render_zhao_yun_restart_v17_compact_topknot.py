"""Render Zhao Yun with the compact strand-textured topknot."""
...
BLEND = SRC / "zhao-yun-restart-v17-compact-topknot.blend"
PREVIEW = SRC / "zhao-yun-restart-v17-compact-topknot-preview.png"
FACE = SRC / "zhao-yun-restart-v17-compact-topknot-face.png"
...
def render(path, resolution):
    ...
    base.look_at(camera, (0.0, -0.022, 1.655))
    scene.camera = camera
