"""Render Zhao Yun full-body previews with the accepted V33 face presentation."""
...
BLEND = SRC / "zhao-yun-fullbody-v3-face-match.blend"
PREVIEW = SRC / "zhao-yun-fullbody-v3-face-match-preview.png"
FINAL = SRC / "zhao-yun-fullbody-v3-face-match-final.png"
