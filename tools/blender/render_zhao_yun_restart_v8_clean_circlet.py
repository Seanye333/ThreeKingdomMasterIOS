"""Render the cleaned fresh Zhao Yun v8."""
...
BLEND = SRC / "zhao-yun-restart-v8-clean-circlet.blend"
PREVIEW = SRC / "zhao-yun-restart-v8-clean-circlet-preview.png"
FACE = SRC / "zhao-yun-restart-v8-clean-circlet-face.png"
