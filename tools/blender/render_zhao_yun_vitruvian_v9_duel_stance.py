"""Render full-body and closer duel-card views of Zhao Yun v9."""
...
BLEND = SRC / "zhao-yun-vitruvian-v9-duel-stance.blend"
PREVIEW = SRC / "zhao-yun-vitruvian-v9-duel-preview.png"
FULL = SRC / "zhao-yun-vitruvian-v9-duel-full.png"
HERO = SRC / "zhao-yun-vitruvian-v9-duel-hero.png"
...
def configure_scene():
    ...
    lower_data = bpy.data.lights.new("ZhaoYun_V9_Lower_Fill", "AREA")
    lower_data.energy = 54.0
    lower_data.shape = "DISK"
    lower_data.size = 1.6
    lower_data.color = (0.54, 0.68, 1.0)
    lower = bpy.data.objects.new("ZhaoYun_V9_Lower_Fill", lower_data)
    bpy.context.collection.objects.link(lower)
    lower.location = (0.80, -2.15, 0.60)
    look_at(lower, (0.0, 0.0, 0.76))
...
def main():
    ...
    if "--preview" in sys.argv:
        render(scene, camera, PREVIEW, (1.48, -4.90, 1.18), (0.0, 0.0, 1.14), 74, (700, 900), 40)
        return
    if "--full" in sys.argv:
