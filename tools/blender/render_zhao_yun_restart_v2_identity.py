"""Render the first portrait-identity pass on the fresh Zhao Yun head."""
...
BLEND = SRC / "zhao-yun-restart-v2-identity.blend"
PREVIEW = SRC / "zhao-yun-restart-v2-identity-preview.png"
