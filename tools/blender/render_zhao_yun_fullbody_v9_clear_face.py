"""Render the V33-exact full-body Zhao Yun with a clear face silhouette."""
...
BLEND = SRC / "zhao-yun-fullbody-v9-clear-face.blend"
PREVIEW = SRC / "zhao-yun-fullbody-v9-clear-face-preview.png"
FINAL = SRC / "zhao-yun-fullbody-v9-clear-face-final.png"
