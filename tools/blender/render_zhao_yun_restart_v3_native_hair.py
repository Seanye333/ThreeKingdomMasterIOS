"""Render the clean restart Zhao Yun with native strand hair."""
...
BLEND = SRC / "zhao-yun-restart-v3-native-hair.blend"
PREVIEW = SRC / "zhao-yun-restart-v3-native-hair-preview.png"
