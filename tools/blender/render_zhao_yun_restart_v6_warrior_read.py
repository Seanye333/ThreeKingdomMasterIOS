"""Render the fresh Zhao Yun warrior-read preview."""
...
BLEND = SRC / "zhao-yun-restart-v6-warrior-read.blend"
PREVIEW = SRC / "zhao-yun-restart-v6-warrior-read-preview.png"
FACE = SRC / "zhao-yun-restart-v6-warrior-read-face.png"
...
def render(path, resolution):
    ...
    base.look_at(camera, (0.0, -0.022, 1.625))
    scene.camera = camera
