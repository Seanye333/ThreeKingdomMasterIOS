...
export const GLOSSARY: GlossaryCategory[] = [
  {
    ...
    terms: [
      ...
      { zh: '野戰繳獲', en: 'Field spoils', descZh: '野戰/攔截/拔寨獲勝即剝取敗軍輜重:糧 = 敵折損 ×1.5(直補勝方隨軍糧;未帶糧則歸源城)、金 = ×0.04 歸源城;拔寨奪其積聚再 ×1.5。守軍出擊獲勝繳獲入城。野戰勝利自此有實利。', descEn: "Win a field clash and you strip the loser's baggage: grain (straight into your column's train) and coin; storming a camp yields its stores on top." },
    ],
  },
  {
