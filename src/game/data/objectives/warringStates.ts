  ...
  'scn-ws-seven': [
      ...
      secondary: [
        {
          ...
          description: "Take Chang'an by 202 — the largest state has never once used its size.",
          descriptionZh: "於202年前西取長安 —— 楚地五千里,帶甲百萬,從未真正用出來過。",
          goal: { kind: 'hold-cities', cityIds: ['changan'], byYear: 202 },
        },
        {
      ...
      secondary: [
        {
          ...
          description: 'Take Linzi by 197 — twenty-eight years of humiliation, repaid in one campaign.',
          descriptionZh: "於197年前攻取臨淄 —— 築黃金台以求士,雪二十八年之恥。",
          goal: { kind: 'hold-cities', cityIds: ['linzi'], byYear: 197 },
        },
      ],
    },
    {
      ...
      secondary: [
        {
          ...
          description: "Take Chang'an by 202 — Wuling's own plan: ride south out of the steppe.",
          descriptionZh: "於202年前攻取長安 —— 武靈王的舊策:自雲中南襲咸陽。",
          goal: { kind: 'hold-cities', cityIds: ['changan'], byYear: 202 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: "Still hold Chenliu and Puyang in 197 — Daliang and the Yellow River bend; Wei's greatness was a century ago.",
        descriptionZh: "至197年仍據陳留、濮陽 —— 大梁與河曲之地。魏之強是一百年前的事了。",
        goal: { kind: 'hold-cities', cityIds: ['chenliu', 'puyang'], byYear: 197 },
      },
      secondary: [
        {
          title: { zh: '重整武卒', en: 'Rebuild the Wu Zu' },
          description: 'Hold Chenliu, Luoyang and Puyang by 197 — the first hegemon, fallen to a buffer state.',
          descriptionZh: "於197年前據陳留、洛陽、濮陽 —— 戰國首霸,如今夾在秦齊之間。",
          goal: { kind: 'hold-cities', cityIds: ['chenliu', 'luoyang', 'puyang'], byYear: 197 },
        },
      ],
    },
    {
  ...
  'scn-ws-weiwen': [
      ...
      secondary: [
        {
          ...
          description: "Take Chang'an and Tongguan by 190 — Wu Qi held this line against Qin for decades.",
          descriptionZh: "於190年前西取長安、潼關 —— 吳起守西河,秦兵不敢東向。",
          goal: { kind: 'hold-cities', cityIds: ['changan', 'tongguan'], byYear: 190 },
        },
        {
          title: { zh: '首霸中原', en: 'First Hegemon' },
          description: 'Hold Chenliu, Luoyang and Ye by 193.',
          descriptionZh: "於193年前據陳留、洛陽、鄴城 —— 用李悝變法,魏最先強。",
          goal: { kind: 'hold-cities', cityIds: ['chenliu', 'luoyang', 'ye'], byYear: 193 },
        },
      ],
    },
    {
      ...
      secondary: [
        {
          ...
          description: "Still hold Chang'an in 190 — before Shang Yang, Qin is the weak one.",
          descriptionZh: "至190年仍守長安 —— 商鞅未至,此時的秦是弱國。",
          goal: { kind: 'hold-cities', cityIds: ['changan'], byYear: 190 },
        },
        {
    ...
    },
    {
      ...
      primary: {
        ...
        description: 'Take Ye and Shangdang by 193.',
        descriptionZh: "於193年前據鄴城、上黨 —— 三家分晉,魏最強而趙不甘。",
        goal: { kind: 'hold-cities', cityIds: ['ye', 'shangdang'], byYear: 193 },
      },
    },
    {
      id: 'obj-wswen-chu',
  ...
  'scn-ws-shangyang': [
    {
      ...
      primary: {
        ...
        description: "Still hold Chang'an, Tongguan and Chencang in 191 — the law needs a decade before it needs an army.",
        descriptionZh: "至191年仍據長安、潼關、陳倉 —— 法行十年,秦民大悅,道不拾遺;東出是那之後的事。",
        goal: { kind: 'hold-cities', cityIds: ['changan', 'tongguan', 'chencang'], byYear: 191 },
      },
      secondary: [
        {
          title: { zh: '徙木立信', en: 'The Pole at the South Gate' },
          description: 'Take Tongguan, Luoyang and Chenliu by 191 — law before conquest, then conquest.',
          descriptionZh: "於191年前東取潼關、洛陽、陳留 —— 先立法,後出兵。",
          goal: { kind: 'hold-cities', cityIds: ['tongguan', 'luoyang', 'chenliu'], byYear: 191 },
        },
        {
    ...
    },
    {
      ...
      primary: {
        ...
        description: "Still hold Chenliu and Puyang in 194 — 'I regret not heeding Gongshu Zuo.' Wei never did put Qin down.",
        descriptionZh: "至194年仍據陳留、濮陽 ——「寡人恨不用公叔座之言」。魏終究沒能除掉秦。",
        goal: { kind: 'hold-cities', cityIds: ['chenliu', 'puyang'], byYear: 194 },
      },
      secondary: [
        {
          title: { zh: '悔不殺鞅', en: 'We Should Have Killed Him' },
          description: 'Destroy the Qin force by 194 — you had Shang Yang in your court and let him go west.',
          descriptionZh: "於194年前擊滅秦國 —— 公叔痤說「不用則殺之」,你沒有聽。",
          goal: { kind: 'defeat-force', forceId: 'qin', byYear: 194 },
        },
        {
          title: { zh: '保有河西', en: 'Keep the West Bank' },
          description: 'Still hold Chenliu and Luoyang in 190.',
          descriptionZh: "至190年仍保陳留、洛陽。",
          goal: { kind: 'hold-cities', cityIds: ['chenliu', 'luoyang'], byYear: 190 },
        },
      ],
    },
    {
      ...
      secondary: [
        {
          ...
          description: "Take Chang'an by 196.",
          descriptionZh: "於196年前攻取長安 —— 六國合縱,楚為縱長。",
  ...
  'scn-ws-guiling': [
      ...
      secondary: [
        {
          ...
          description: 'Destroy the Wei force by 187 — Sun Bin owes Pang Juan a death.',
          descriptionZh: "於187年前擊滅魏國 —— 孫臏與龐涓之間,還有一筆帳。",
          goal: { kind: 'defeat-force', forceId: 'wei', byYear: 187 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: 'Take Ye by 183 and still hold Chenliu — take Zhao before Qi reaches your capital.',
        descriptionZh: "於183年前攻下鄴城,且陳留不失 —— 要在齊軍抵達大梁之前拿下邯鄲。",
        goal: { kind: 'hold-cities', cityIds: ['ye', 'chenliu'], byYear: 183 },
      },
    },
    {
      id: 'obj-wsgl-zhao',
    ...
    },
    {
      ...
      primary: {
        ...
        description: "Still hold Chang'an, Tongguan and Hanzhong in 187 — let Wei and Qi bleed each other first.",
        descriptionZh: "至187年仍據長安、潼關、漢中 —— 三晉相攻,秦坐收其弊,此時不必東出。",
        goal: { kind: 'hold-cities', cityIds: ['changan', 'tongguan', 'hanzhong'], byYear: 187 },
      },
      secondary: [
        {
          title: { zh: '坐觀三晉', en: 'Watch the Three Jin Bleed' },
          description: 'Take Luoyang and Tongguan by 187 — let Wei and Qi wear each other out.',
          descriptionZh: "於187年前東取洛陽、潼關 —— 三晉相攻,秦收其利。",
  ...
  'scn-ws-hangu': [
    {
      ...
      primary: {
        ...
        description: 'Still hold Hanguguan and Tongguan in 183 — one pass, five armies.',
        descriptionZh: "至183年仍守函谷關、潼關 —— 五國之師百萬,叩關而攻。",
        goal: { kind: 'hold-cities', cityIds: ['hanguguan', 'tongguan'], byYear: 183 },
      },
      secondary: [
        {
    ...
    },
    {
      ...
      primary: {
        ...
        description: 'Hold Linzi, Pengcheng and Langya by 185 — let the others break themselves on the pass.',
        descriptionZh: "於185年前據臨淄、彭城、琅琊 —— 遠交近攻,齊之所以最後亡。",
      ...
      secondary: [
        {
          ...
          descriptionZh: "於188年前滅韓 —— 近攻之始。",
          goal: { kind: 'defeat-force', forceId: 'han', byYear: 188 },
        },
      ],
    },
    {
  ...
  'scn-ws-yanying': [
      ...
      secondary: [
        {
          ...
          description: 'Hold Yiling by 186 — the tombs of the Chu kings.',
          descriptionZh: "於186年前據夷陵 —— 燒楚先王之墓,楚人自此不能復振。",
          goal: { kind: 'hold-cities', cityIds: ['yiling'], byYear: 186 },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      primary: {
        ...
        description: 'Hold Linzi and Pengcheng by 186.',
        descriptionZh: "於186年前據臨淄、彭城。",
        goal: { kind: 'hold-cities', cityIds: ['linzi', 'pengcheng'], byYear: 186 },
      },
    },
    {
      id: 'obj-wsyy-zhao',
      ...
      primary: {
        ...
        description: 'Hold Ye, Taiyuan and Shangdang by 186.',
        descriptionZh: "於186年前據鄴城、太原、上黨 —— 楚既弱,能抗秦者唯趙。",
  ...
  'scn-ws-yuyu': [
    {
      ...
      primary: {
        ...
        description: 'Hold Shangdang and Taiyuan by 183 — Zhao She marched thirty li out and then ran.',
        descriptionZh: "於183年前據上黨、太原 —— 趙奢去邯鄲三十里而止,再一日一夜疾趨。",
        goal: { kind: 'hold-cities', cityIds: ['shangdang', 'taiyuan'], byYear: 183 },
      },
      secondary: [
        {
          title: { zh: '再破秦軍', en: 'Beat Qin Again' },
          description: 'Destroy the Qin force by 188 — Yuyu is the only field defeat Qin took in this era.',
          descriptionZh: "於188年前擊滅秦國 —— 閼與是這個時代秦唯一一次野戰大敗。",
          goal: { kind: 'defeat-force', forceId: 'qin', byYear: 188 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: "Still hold Chang'an, Tongguan and Hanzhong in 183 — Yuyu was the one defeat; it cost Qin nothing at home.",
        descriptionZh: "至183年仍據長安、潼關、漢中 —— 閼與是秦東出以來唯一的敗仗,而關中未損分毫。",
        goal: { kind: 'hold-cities', cityIds: ['changan', 'tongguan', 'hanzhong'], byYear: 183 },
      },
      secondary: [
        {
          title: { zh: '取閼與', en: 'Take Yuyu' },
          description: 'Take Shangdang by 183 — a road too narrow for the loser to retreat.',
          descriptionZh: "於183年前攻取上黨 —— 其道遠險狹,譬之猶兩鼠鬥於穴中。",
          goal: { kind: 'hold-cities', cityIds: ['shangdang'], byYear: 183 },
        },
      ],
    },
    {
  ...
  'scn-ws-qimin': [
    {
      ...
      primary: {
        ...
        description: 'Declare yourself emperor and take Shouchun by 184 — Qi at its height swallowed Song.',
        descriptionZh: "稱帝建號並於184年前取壽春 —— 齊之極盛,滅宋而稱東帝。",
        goal: { kind: 'declare-emperor' },
      },
      secondary: [
        {
          title: { zh: '滅宋取淮', en: 'Swallow Song' },
          description: 'Hold Pengcheng, Xiapi and Shouchun by 184.',
          descriptionZh: "於184年前據彭城、下邳、壽春 —— 得宋地則齊愈驕,諸侯愈懼。",
          goal: { kind: 'hold-cities', cityIds: ['pengcheng', 'xiapi', 'shouchun'], byYear: 184 },
        },
      ],
    },
    {
  ...
  'scn-ws-yueyi': [
    ...
    },
    {
      ...
      primary: {
        ...
        description: 'Survive to 185, then retake Linzi — two cities are enough to come back from.',
        descriptionZh: "存續至185年,再復臨淄 —— 只剩兩城,也還能復國。",
        goal: { kind: 'survive-until', year: 185 },
      },
      secondary: [
        {
          title: { zh: '復齊七十城', en: 'Retake the Seventy' },
          description: 'Hold Linzi and Beihai by 188.',
          descriptionZh: "於188年前收復臨淄、北海。",
          goal: { kind: 'hold-cities', cityIds: ['linzi', 'beihai'], byYear: 188 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: "Still hold Chang'an, Tongguan and Hanzhong in 185 — Qi and Yan are destroying the only rival Qin feared.",
        descriptionZh: "至185年仍據長安、潼關、漢中 —— 齊燕互毀,秦所畏者自去,不必費一兵。",
        goal: { kind: 'hold-cities', cityIds: ['changan', 'tongguan', 'hanzhong'], byYear: 185 },
      },
      secondary: [
        {
          title: { zh: '東方兩敗', en: 'Both Eastern Powers Bleed' },
          description: 'Take Luoyang, Chenliu and Shangdang by 185.',
          descriptionZh: "於185年前取洛陽、陳留、上黨 —— 燕齊相殘,秦得從容東出。",
          goal: { kind: 'hold-cities', cityIds: ['luoyang', 'chenliu', 'shangdang'], byYear: 185 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: 'Hold Ye, Shangdang and Taiyuan by 185 — Yue Yi ended his life in Zhao.',
        descriptionZh: "於185年前據鄴城、上黨、太原 —— 樂毅最後奔趙,趙封之於觀津。",
      ...
      secondary: [
        {
          ...
          description: 'Take Shangdang and Ye by 184 — swap the general in secret, cut the supply road, then wait.',
          descriptionZh: "於184年前取上黨、鄴城 —— 陰使武安君為將,絕其糧道,然後圍之。",
          goal: { kind: 'hold-cities', cityIds: ['shangdang', 'ye'], byYear: 184 },
        },
        {
          title: { zh: '滅趙', en: 'End Zhao' },
          description: 'Destroy the Zhao force by 186.',
          descriptionZh: "於186年前滅趙 —— 趙卒四十萬既坑,邯鄲可下。",
      ...
      secondary: [
        {
          ...
          description: 'Survive to 188.',
          descriptionZh: "存續至188年 —— 四十萬人的性命,換一個活下去的趙國。",
          goal: { kind: 'survive-until', year: 188 },
        },
      ],
    },
    {
      ...
      secondary: [
        {
          ...
          description: 'Take Ye by 184 — Bai Qi refused this campaign and was ordered to die for it.',
          descriptionZh: "於184年前攻下鄴城 —— 武安君稱病不行,終賜劍杜郵。",
          goal: { kind: 'hold-cities', cityIds: ['ye'], byYear: 184 },
        },
        {
          title: { zh: '滅趙', en: 'End Zhao' },
          description: 'Destroy the Zhao force by 188.',
          descriptionZh: "於188年前滅趙。",
          goal: { kind: 'defeat-force', forceId: 'zhao', byYear: 188 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: 'Still hold Ye in 186 — after Changping, with the city eating its own dead.',
        descriptionZh: "至186年仍守鄴城 —— 長平之後,城中析骨而炊,易子而食。",
        goal: { kind: 'hold-cities', cityIds: ['ye'], byYear: 186 },
      },
      secondary: [
        {
          title: { zh: '反攻', en: 'Push Them Back' },
          description: 'Take Shangdang and Taiyuan by 188.',
          descriptionZh: "於188年前收復上黨、太原 —— 圍解之後,失地當復。",
          goal: { kind: 'hold-cities', cityIds: ['shangdang', 'taiyuan'], byYear: 188 },
        },
      ],
    },
    {
  ...
  'scn-ws-tiandan': [
    {
      ...
      primary: {
        ...
        description: 'Retake Linzi and Beihai by 183 — a thousand oxen, blades on their horns, reeds alight on their tails.',
        descriptionZh: "於183年前收復臨淄、北海 —— 牛千餘,束兵刃於角,灌脂束葦於尾而燒之。",
      ...
      secondary: [
        {
          ...
          descriptionZh: "於188年前逐燕出境 —— 七十餘城,一城不留。",
      ...
      secondary: [
        {
          ...
          description: 'Take Luoyang, Xuchang and Shangdang by 185.',
          descriptionZh: "於185年前取洛陽、許昌、上黨 —— 范雎之策,自韓魏始。",
          goal: { kind: 'hold-cities', cityIds: ['luoyang', 'xuchang', 'shangdang'], byYear: 185 },
        },
      ],
    },
    {
  ...
  'scn-ws-qin-unify': [
      ...
      secondary: [
        {
          ...
          description: 'Destroy the Han force by 188.',
          descriptionZh: "於188年前滅韓 —— 六國之滅,自韓始。",
          goal: { kind: 'defeat-force', forceId: 'han', byYear: 188 },
        },
      ],
    },
      ...
      secondary: [
        {
          ...
          descriptionZh: "至190年仍保江陵、壽春。",
          goal: { kind: 'hold-cities', cityIds: ['jiangling', 'shouchun'], byYear: 190 },
        },
      ],
    },
    {
      ...
      secondary: [
        {
          ...
          description: 'Take Pengcheng, Chenliu and Luoyang by 192.',
          descriptionZh: "於192年前西取彭城、陳留、洛陽 —— 這一次不要等到最後。",
          goal: { kind: 'hold-cities', cityIds: ['pengcheng', 'chenliu', 'luoyang'], byYear: 192 },
        },
      ],
    },
    {
      ...
      primary: {
        ...
        description: 'Still hold Chenliu and Puyang in 190 — Wang Ben turned the Yellow River onto the city.',
        descriptionZh: "至190年仍保陳留、濮陽 —— 王賁引河溝灌大梁,三月城壞。",
        goal: { kind: 'hold-cities', cityIds: ['chenliu', 'puyang'], byYear: 190 },
      },
    },
    {
      id: 'obj-wsqu-yan',
    ...
    },
    {
      ...
      primary: {
        ...
        description: 'Survive to 190 — Han is first on the list.',
        descriptionZh: "存續至190年 —— 名單上的第一個就是你。",
