...
export const BIOGRAPHIES: Record<string, OfficerBiography> = {
  ...
  'guan-yu': {
    era: { zh: '武聖', en: 'Saint of War' },
    zh: '字云長,河東解良人。身長九尺,髯長二尺,面如重棗。義薄云天,與劉備，張飛結為兄弟。 千里走單騎,過五關斬六將。水淹七軍,威震華夏,敗走麥城而死。后世尊為武聖,廟祀遍天下。',
    ...
    quote: { zh: '玉可碎而不可改其白,竹可焚而不可毀其節。', en: 'Jade may shatter but its whiteness will not change; bamboo may burn but its uprightness will not be destroyed.' },
  },
  'zhang-fei': {
  ...
  'zhao-yun': {
    era: { zh: '常勝將軍', en: 'The Ever-Victorious' },
    zh: '字子龍,常山真定人。身長八尺,姿顏雄偉。 長坂坡中七進七出,懷抱阿斗殺出重圍。一生未嘗敗績,劉備嘆曰:"子龍一身都是膽。" 蜀漢五虎之一。',
    ...
    quote: { zh: '臣子今日所為,皆是分内事!', en: "What I have done today is no more than a subject's duty!" },
  },
  'zhuge-liang': {
    era: { zh: '臥龍', en: 'The Sleeping Dragon' },
    zh: '字孔明,琅琊陽都人。身長八尺,容貌甚偉,躬耕于南陽,自比管樂。三顧而出,獻《隆中對》,定天下三分之策。火燒博望,赤壁借東風,空城退仲達。鞠躬尽瘁,死而后已,星隕五丈原。',
  ...
  'sun-jian': {
    era: { zh: '江東之虎', en: 'Tiger of Jiangdong' },
    zh: '字文台,吳郡富春人。少年時孤身追海盜,聲名遠播。討黃巾，伐董卓,首入洛陽,得傳國玉璽。征荊州劉表,中流矢而死,年三十七。',
  ...
  'sima-yi': {
    ...
    zh: '字仲達,河内溫縣人。隱忍多智,曹操疑其有狼顧之相而忌之。 历事曹操，丕，叡，芳四主。 拒諸葛于五丈原,平遼東公孫淵。 晚年发動高平陵之變,奪曹爽之權,為西晉開基。',
  ...
  'zhang-liao': {
    zh: '字文遠,雁門馬邑人。原從呂布,敗后歸曹操。 合肥之戰率八百死士冲孫權十萬軍,幾擒孫權,江東聞其名小兒不敢夜啼。',
  ...
  'pang-tong': {
    era: { zh: '鳳雛', en: 'The Young Phoenix' },
    zh: '字士元,襄陽人。 與諸葛齊名,水鏡先生云:"臥龍鳳雛,得一可安天下。" 獻連環計于曹營,后歸劉備,落鳳坡中箭而亡。',
  ...
  'xu-chu': {
    ...
    zh: '字仲康,譙縣人。 力大無窮,曾倒拖牛尾百步。 曹操親衛長。 與馬超大戰二百合不分勝負,赤膊力斗,以勇名重于世。',
  ...
  'lu-meng': {
    era: { zh: '士別三日,即更刮目相待', en: 'Three days apart, look at him with new eyes' },
    zh: '字子明,汝南富陂人。 少時不學,孫權勸學,刻苦自勵,日積月累遂成大器。 白衣渡江,襲取荊州,擒殺關羽。',
  ...
  'lu-xun': {
    zh: '字伯言,吳郡吳縣人。 出身江東大族。 夷陵之戰,以白面書生之姿火燒連營七百里,大破劉備。 后任丞相,輔佐孫權。',
  ...
  'diaochan': {
    era: { zh: '貂蟬', en: 'Diaochan' },
    zh: '王允義女,容貌傾國。 司徒以連環之計,使呂布，董卓父子反目。 鳳儀亭一變,董卓死,漢室得蘇。 四大美人之一。',
  ...
  'yuan-shao': {
    zh: '字本初,汝南汝陽人。 四世三公之家。 起兵討董卓,眾推為盟主。 后據河北,勢力最盛。 官渡之戰為曹操所破,郁郁而終。',
  ...
  'xiahou-dun': {
    zh: '字元讓,曹操族兄弟。 與呂布軍戰時被流矢射中左眼,自拔之吞食,曰:"父精母血,不可棄也!" 后世稱"獨眼夏侯"。',
  ...
  'guo-jia': {
    ...
    zh: '字奉孝,潁川陽翟人。 曹操第一謀主,十勝十敗論奠定北征方略。 三十八歲早逝,曹操痛哭:"若奉孝在,孤不至于此!"',
  ...
  'xun-yu': {
    zh: '字文若,潁川潁陰人。 王佐之才,曹操稱之"吾之子房"。 助曹定都許昌，迎天子,運籌帷幄二十年。 后因反對曹操稱魏公,郁郁而終。',
  ...
  'cao-pi': {
    ...
    zh: '字子桓,曹操次子。 廢獻帝而代之,建立曹魏。 工于詩賦,與建安七子齊名。 七步逼弟曹植,留下"煮豆燃豆萁"之千古名篇。',
  ...
  'cao-zhi': {
    zh: '字子建,曹操三子。 才高八斗,與曹操，曹丕并稱三曹。 七步成詩:"煮豆燃豆萁,豆在釜中泣;本是同根生,相煎何太急!"',
  ...
  'wang-yun': {
    zh: '字子師,太原祁縣人。 漢室忠臣,假女貂蟬施連環計,使呂布刺殺董卓。 后被李傕，郭汜攻陷長安,自焚而死。',
...
const SUPPLEMENTAL_QUOTES: Record<string, { zh: string; en: string }> = {
  'sima-yi':    { zh: '亮志大而不見機,多謀而少決,好兵而無權。', en: 'Liang is grand in ambition but blind to opportunity, full of schemes yet slow to decide, fond of arms yet without the means.' },
