...
describe('戰役覆蓋率(序章 / 目標)', () => {
  ...
  const COMPLETE = ['scn-184-yellow-turban', 'scn-190-anti-dong-zhuo', 'scn-195-jiangdong', 'scn-200-guandu'];
