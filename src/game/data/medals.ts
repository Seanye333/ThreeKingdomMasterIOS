...
export interface MedalDef {
  ...
  /** 徽記 — the single glyph struck into the badge face (MedalBadge). */
  glyph: string;
}

export const MEDALS: MedalDef[] = [
  { id: 'medal-slayer', name: { zh: '萬人屠', en: 'Slayer of Hosts' }, deed: 'killsTroops', threshold: 50000,
    descriptionZh: '累斬敵軍五萬 — 武力 +1', description: '50,000 foes cut down — War +1.', glyph: '刀', stat: 'war' },
  { id: 'medal-duelist', name: { zh: '鬥將', en: 'Duelist' }, deed: 'duelsWon', threshold: 10,
    descriptionZh: '單挑十勝 — 武力 +1', description: 'Ten duels won — War +1.', glyph: '戟', stat: 'war' },
  { id: 'medal-conqueror', name: { zh: '拔城將', en: 'City-Taker' }, deed: 'citiesTaken', threshold: 5,
    descriptionZh: '親拔五城 — 統率 +1', description: 'Five cities taken — Leadership +1.', glyph: '城', stat: 'leadership' },
  { id: 'medal-veteran', name: { zh: '百戰宿將', en: 'Hundred-Battle Veteran' }, deed: 'battlesWon', threshold: 20,
    descriptionZh: '會戰二十勝 — 統率 +1', description: 'Twenty battles won — Leadership +1.', glyph: '旗', stat: 'leadership' },
  { id: 'medal-orator', name: { zh: '舌燦蓮花', en: 'Silver Tongue' }, deed: 'debatesWon', threshold: 15,
    descriptionZh: '舌戰十五勝 — 魅力 +1', description: 'Fifteen debates won — Charisma +1.', glyph: '舌', stat: 'charisma' },
  { id: 'medal-shadow', name: { zh: '暗棋', en: 'Hidden Piece' }, deed: 'espionageSuccess', threshold: 10,
    descriptionZh: '用間十成 — 智力 +1', description: 'Ten missions of shadow-work — Intelligence +1.', glyph: '棋', stat: 'intelligence' },
  { id: 'medal-steward', name: { zh: '能吏', en: 'Able Steward' }, deed: 'civicWorks', threshold: 30,
    descriptionZh: '政績三十件 — 政治 +1', description: 'Thirty works of governance — Politics +1.', glyph: '印', stat: 'politics' },
  { id: 'medal-warden', name: { zh: '擒龍手', en: 'Taker of Captives' }, deed: 'captured', threshold: 8,
    descriptionZh: '陣擒八將 — 武力 +1', description: 'Eight officers taken alive — War +1.', glyph: '索', stat: 'war' },
];
