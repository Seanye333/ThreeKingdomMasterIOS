...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  // ── 2026-07 民政批(§1.11–§1.14 / §3.6 / §5.14)──
  {
    id: 'ach-clear-docket',
    name: { en: 'Courts Clear', zh: '訟簡刑清' },
    description: 'Work a great city\'s backlog of unheard cases down to nothing.',
    descriptionZh: '大城積案盡決,獄無滯訟 —— 一季坐堂,勝過十年空言。',
    tier: 'bronze',
    trigger: { kind: 'clear-docket' },
  },
  {
    id: 'ach-amnesty',
    name: { en: 'Pardon Under Heaven', zh: '大赦天下' },
    description: 'Proclaim a general amnesty — every court in the realm emptied at once.',
    descriptionZh: '大赦天下,獄訟一空,萬民稱慶;然縱囚歸鄉,盜賊亦復起。',
    tier: 'silver',
    trigger: { kind: 'amnesty' },
  },
  {
    id: 'ach-registers-whole',
    name: { en: 'Every Household Counted', zh: '編戶齊民' },
    description: 'Bring the realm\'s hidden households back onto the tax registers.',
    descriptionZh: '括戶檢地,蔭附盡歸版籍 —— 與豪右爭民,古今第一難事。',
    tier: 'gold',
    trigger: { kind: 'registers-whole' },
  },
  {
    id: 'ach-break-hoard',
    name: { en: 'The Warehouses Opened', zh: '平準抑兼' },
    description: 'Break open a cornered grain market and put the stores back in public hands.',
    descriptionZh: '破豪商之囤,糧入公廩 —— 米價一夕而平,市人相賀。',
    tier: 'silver',
    trigger: { kind: 'break-hoard' },
  },
  {
    id: 'ach-well-armed',
    name: { en: 'Good Steel', zh: '甲堅兵利' },
    description: 'Bring a city\'s armoury up to a state that arms every man who musters there.',
    descriptionZh: '武庫充盈,甲堅兵利 —— 校閱之日,三軍無一人徒手。',
    tier: 'silver',
    trigger: { kind: 'well-armed' },
  },
  {
    id: 'ach-sound-coin',
    name: { en: 'The Coinage Holds', zh: '錢法不改' },
    description: 'Refuse to debase the currency when the treasury is empty and the army wants feeding.',
    descriptionZh: '府庫已竭而錢法不改 —— 董卓之鑄小錢,穀一斛數十萬,前車在焉。',
    tier: 'gold',
    trigger: { kind: 'event-choice', targetId: 'coin-kept-sound' },
  },
  {
    id: 'ach-grain-caravan',
    name: { en: 'The Roads Are Open', zh: '通商惠工' },
    description: 'Let the grain merchants cross your border — and take the customs on it.',
    descriptionZh: '開關通糴,商旅出入 —— 榷場之利,不勞一兵而入府庫。',
    tier: 'bronze',
    trigger: { kind: 'grain-caravan' },
  },
  {
    id: 'ach-wounded-home',
    name: { en: 'They Came Back', zh: '傷卒歸伍' },
    description: 'Return a thousand wounded men to the ranks in a single campaign.',
    descriptionZh: '醫藥不絕,傷者千人復歸行伍 —— 主公不棄我,我輩何惜此身。',
    tier: 'silver',
    trigger: { kind: 'wounded-home' },
  },
  {
    id: 'ach-siege-park',
    name: { en: 'A Forest of Engines', zh: '器械如林' },
    description: 'Mass a full siege park before an enemy city.',
    descriptionZh: '雲梯衝車,列於城下如林 —— 守者望之而色變。',
    tier: 'silver',
    trigger: { kind: 'siege-park' },
  },
  {
    id: 'ach-night-raid',
    name: { en: 'A Hundred Horse', zh: '百騎劫營' },
    description: 'Fire a besieger\'s camp with a night sortie.',
    descriptionZh: '甘寧百騎劫魏營 —— 不求破敵,但焚其所恃。',
    tier: 'gold',
    trigger: { kind: 'night-raid' },
  },
  {
    id: 'ach-writ-complete',
    name: { en: 'The Writ Reaches', zh: '政令通達' },
    description: 'Hold ten cities or more with every one of them on the relay network.',
    descriptionZh: '十城以上而無一斷驛 —— 王命所至,四方無阻。',
    tier: 'gold',
    trigger: { kind: 'writ-complete' },
  },
  {
    id: 'ach-merit-cleared',
    name: { en: 'Nothing Owed', zh: '賞不逾時' },
    description: 'Settle every serving officer\'s merit ledger — no one is owed anything.',
    descriptionZh: '賞不逾時,罰不遷列 —— 帳上無一筆未清,是以士皆用命。',
    tier: 'gold',
    trigger: { kind: 'merit-cleared' },
  },
  {
    id: 'ach-open-exam',
    name: { en: 'Talent Alone', zh: '唯才是舉' },
    description: 'Adopt open examination — and take the great houses\' displeasure with it.',
    descriptionZh: '開科取士,不問門第 —— 寒門為之一振,世家為之側目。',
    tier: 'gold',
    trigger: { kind: 'open-exam' },
  },
  {
    id: 'ach-immortal-verse',
    name: { en: 'A Verse for the Ages', zh: '千古絕唱' },
    description: 'Compose a poem of the very first rank.',
    descriptionZh: '一篇既出,傳於士林 —— 文章者,經國之大業,不朽之盛事。',
    tier: 'gold',
    trigger: { kind: 'immortal-verse' },
  },
  {
    id: 'ach-shrine-raised',
    name: { en: 'Their Names Remembered', zh: '立祠祭故' },
    description: 'Raise a shrine to an officer who died in your service.',
    descriptionZh: '為故將立祠,歲時祭饗 —— 死者有歸,生者知勸。',
    tier: 'bronze',
    trigger: { kind: 'shrine-raised' },
  },
  {
    id: 'ach-sea-lord',
    name: { en: 'Master of the River', zh: '樓船水師' },
    description: 'Win a river battle at the head of a fully drilled fleet.',
    descriptionZh: '以樓船水師之眾決勝江上 —— 北人終於也站得住甲板。',
    tier: 'silver',
    trigger: { kind: 'sea-lord' },
  },
  {
