...
import { shade, ChineseRoof3D, OfficerFigure3D, Residence3D, StreetEncounterFigure, Watchman3D, Refugee3D, MourningBanner3D, FestivalPennants3D, SeasonCtx, NightCtx, InspectCtx, type InspectInfo } from './city3d/Folk3D';
...
import { INSIDE_BUILDING_DEF, InsideBuilding3D, WallSegment3D, innerWallCells, InnerWallSeg3D, InnerGate3D, CityGate3D, CornerTower3D, Moat3D, canalRow, CanalBridge3D, cityBuildPlots, FoundationPlot3D, GhostBuilding3D, ConstructionSite3D, Smoke3D, Banner3D } from './city3d/Architecture3D';
