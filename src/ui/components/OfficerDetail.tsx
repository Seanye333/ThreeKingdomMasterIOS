  ...
  return (
    <div className={styles.backdrop} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <FamilyTreeSection officerId={officer.id} officersOverride={officersOverride} drillDown={drillDown(officersOverride)} />
        <HeirsAndClanSection officerId={officer.id} />
        <RelationshipsSection officerId={officer.id} officersOverride={officersOverride} drillDown={drillDown(officersOverride)} />
        ...
        <section className={styles.statsSection}>
          ...
          <CampaignChronicleBlock officer={officer} officersOverride={officersOverride} drillDown={drillDown(officersOverride)} />
        </section>
...
import {
  RelationshipsSection, CampaignChronicleBlock, BiographyBlock, PortraitColumn,
  StatBar, FamilyTreeSection, HeirsAndClanSection,
} from './officerDetail/Sections';

/**
 * 下鑽 — the sections can open a related officer's own panel, but they cannot
 * import this file to do it (that would be a module cycle), so the renderer is
 * handed to them. Kept at module scope: a fresh closure per render would remount
 * the nested panel on every keystroke in the parent.
 */
const drillDown = (officersOverride?: Record<string, Officer>) =>
  (o: Officer, onClose: () => void) => (
    <OfficerDetail officer={o} onClose={onClose} officersOverride={officersOverride} />
  );
