...
export function OfficerAvatar({
  ...
  const dom = stats[0][0];
  const accent = forceColor ?? '#5a4530';
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" style={{ display: 'block' }}>
      ...
      {/* Head */}
      <ellipse cx="32" cy="30" rx={female ? 10 : 11} ry="12" fill={skin} stroke="#3a2818" strokeWidth="0.5" />
      {/* Hair / hat (varies by dominant stat) */}
      {dom === 'war' && (
        // Warrior helm — peaked iron with cheek guards.
        <>
          <path d="M 20 26 Q 20 12 32 10 Q 44 12 44 26 L 44 22 Q 32 18 20 22 Z" fill="#3a2818" />
          <circle cx="32" cy="11" r="1.5" fill="#b8442e" />
          <path d="M 20 26 L 18 32 L 22 30 Z" fill="#3a2818" />
          <path d="M 44 26 L 46 32 L 42 30 Z" fill="#3a2818" />
        </>
      )}
      {dom === 'leadership' && (
        // General's helm — crested with a horsetail plume.
        <>
          <path d="M 20 28 Q 20 14 32 12 Q 44 14 44 28 L 44 22 Q 32 18 20 22 Z" fill="#5a4530" />
          <path d="M 30 12 L 32 4 L 34 12 Z" fill="#b8442e" />
          <path d="M 32 4 Q 36 2 38 6" fill="none" stroke="#3a2818" strokeWidth="1.2" />
        </>
      )}
      {dom === 'intelligence' && (
        ...
        <>
          ...
          <rect x="22" y="12" width="20" height="4" fill="#3a2818" rx="0.5" />
      ...
      {dom === 'politics' && (
        ...
        <>
          ...
          <rect x="26" y="10" width="12" height="10" fill="#3a2818" rx="0.5" />
      ...
      {dom === 'charisma' && (
        ...
        <>
          <ellipse cx="32" cy="20" rx="11" ry="4" fill="#d4a84a" />
          <rect x="21" y="14" width="22" height="6" fill="#d4a84a" />
      ...
      {!female && officer.birthYear < 180 && (
        <path d="M 26 36 Q 32 40 38 36 Q 36 38 32 39 Q 28 38 26 36 Z" fill="#3a2818" opacity="0.85" />
      )}
      {/* Charisma smile */}
      {s.charisma > 75 && (
